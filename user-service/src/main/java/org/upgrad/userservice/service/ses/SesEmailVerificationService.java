package org.upgrad.userservice.service.ses;
...
public class SesEmailVerificationService {
    ...
    public void sendEmail(UserServiceDto userServiceDto) throws IOException, TemplateException, MessagingException {
        Map<String,Object> templateModel = new HashMap<>();
        templateModel.put("doctorDto",userServiceDto);
        Template freeMarkerTemplate = configurer.getConfiguration().getTemplate("userwelcome.ftl");
        String htmlBody = FreeMarkerTemplateUtils.processTemplateIntoString(freeMarkerTemplate,templateModel);
        sendSimpleMessage(userServiceDto.getEmailId(),"Welcome Email",htmlBody);
    }
